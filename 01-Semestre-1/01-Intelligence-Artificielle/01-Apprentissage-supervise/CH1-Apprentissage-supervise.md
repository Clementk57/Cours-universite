...
point : 
comprendre et aplliquer les fondaments théoriques des méthodes d'apprentissage supervisé 
algorithmes d'apprentissage neuronal 
apprentissage et géneralisation dans des systmes artificiels 
reseaux de neurones constructifs

Qu'est ce qu'apprendre automatique ?

on ne veut pas faire croire que la machine développe une façon de pensée des sensations ou des connaissances humaines

Utiliser une métaphore pour construire des systems artificial

z langues : tres bien dotées de RE français/englais...
m langues moyenemment """ arabe 
$pi$ langue peu detées """ alsaciens 


apprentissage est une caractéristique fondamentale
